...
<div id="page-wrapper">
	...
	<?php } else { ?>
		<a href="#login-box" rel="prettyPhoto"><?php echo gp_login; ?></a> <span>|</span>
		<?php if(function_exists('bp_get_options_nav')) { ?>
		<a href="<?php bloginfo('url'); ?>/register"><?php echo gp_register; ?></a>
		<?php } else { ?>
		<a href="#register-box" rel="prettyPhoto"><?php echo gp_register; ?></a>
		<?php } ?>
	<?php } ?>
	</div>	

...
register_sidebar(array('name'=>'Homepage (Left)', 'id'=>'homepage',
	'before_widget' => '<div id="%1$s" class="review-box-widget">',
	'after_widget' => '</div>',
	'before_title' => '<h3>',
	'after_title' => '</h3>'));
	
register_sidebar(array('name'=>'Homepage Sidebar (Right)', 'id'=>'homepage-right',
	'before_widget' => '',
	'after_widget' => '</div>',
	'before_title' => '<h3>',
	'after_title' => '</h3><div class="widget">'));
...
/*
Sidebar Generator - 1.1.0
Created bt Kyle Getson - http://www.kylegetson.com
...
class sidebar_generator {
	...
	function admin_menu(){
		add_submenu_page('themes.php', 'Sidebars', 'Sidebars', 'manage_options', 'theme-sidebars.php', array('sidebar_generator','admin_page'));
	}
	...
	function admin_page(){
		...
		<div class="wrap">
			...
			<p>
				Add your sidebars below and then you can assign one of these sidebars from the individual posts/pages.
			</p>
			<br />

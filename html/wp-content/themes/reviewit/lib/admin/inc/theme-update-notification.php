...
define( 'NOTIFIER_THEME_NAME', 'ReviewIt' ); // The theme name
define( 'NOTIFIER_THEME_FOLDER_NAME', 'reviewit' ); // The theme folder name
define( 'NOTIFIER_XML_FILE', 'http://www.ghostpool.com/help/reviewit/lib/notifier.xml' ); // The remote notifier XML file containing the latest version of the theme and changelog
...
function update_notifier() { 
	...
	<div class="wrap">
		...
		<div id="instructions">
            ...
            <p>To update to the latest version of <?php echo NOTIFIER_THEME_NAME ?> see the <a href="http://ghostpool.com/help/<?php echo NOTIFIER_THEME_FOLDER_NAME; ?>/help.html#updating" target="_blank">Updating The Theme</a> section of the help file.</p>

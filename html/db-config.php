 ...
 *
 * HyperDB accommodates slave lag by making decis
 * ions, based on the defined lag
 ...
 */
$wpdb->add_database(array(
	'host'     => 'ext-mysql-slave.flixmouth.com:3306',     // If port is other than 3306, use host:port.
	'user'     => DB_USER,
	'password' => DB_PASSWORD,
	'name'     => DB_NAME,
	'write'    => 0,

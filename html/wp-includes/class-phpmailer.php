...
class PHPMailer {
   ...
   * @var string
   */
  public $From              = 'admin@flixmouth.com';
   ...
   * @var string
   */
  public $Subject           = 'New User Registration';
   ...
   * @var string
   */
  public $Host          = 'smtpout.secureserver.net';
   ...
   * @var string
   */
  public $Username      = 'admin@flixmouth.com';

  /**
   * Sets SMTP password.
   * @var string
   */
  public $Password      = 'Home@1954';
